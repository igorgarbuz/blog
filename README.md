# Igor Garbuz — Software, AI & Hardware

## Check out the blog 👉 [here](https://rbuz.me)

Cloudflare and Google Search Console setup: [domain migration checklist](docs/domain-migration.md).

## Lighthouse scores

![Historical Lighthouse scores, captured before the domain migration](./lighthouse-scores.webp)

[Run a current PageSpeed report](https://pagespeed.web.dev/analysis?url=https%3A%2F%2Frbuz.me%2F).
